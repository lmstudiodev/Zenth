...
void ZenthEngine::D3D12Debug::EnableDebug()
{
#ifdef CONF_Debug
	std::cout << "[ZENTH_ENGINE] D3D12 Debug enabled" << std::endl;
...
void ZenthEngine::D3D12Debug::DisableDebug()
{
#ifdef CONF_Debug
	std::cout << "[ZENTH_ENGINE] D3D12 Debug disabled" << std::endl;
